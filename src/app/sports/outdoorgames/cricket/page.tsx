  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center text-white overflow-hidden">
      {/* Meteor Effect */}{isLoading ? (
        ...
        <>
          <Image
            src="/images/bgimg/bgcricket.jpg" // Replace with your actual logo path
            alt="Cricekt background"
            width={850}
            height={50}
          ...
          <div className="relative z-10 p-4 sm:p-30">
            ...
            <div className="flex justify-center mt-6">
              <Image
                src="/images/outdoorgames/cricket.png" // Replace with your actual logo path
                alt="Event Logo"
                width={150}
                height={150}
