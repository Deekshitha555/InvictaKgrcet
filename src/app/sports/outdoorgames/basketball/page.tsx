  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center text-white overflow-hidden">
      ...
      {isLoading ? (
        ...
        <>
      <Image
            src="/images/bgimg/bgbasketball.jpg" // Replace with your actual logo path
      ...
      <div className="relative z-10 p-4 sm:p-30">
        ...
        <div className="flex justify-center mt-6">
          <Image
            src="/images/outdoorgames/basketball.png" // Replace with your actual logo path
            alt="Event Logo"
            width={150}
            height={150}
        ...
        {/* Cards Section */}
        <motion.div
          className="mt-10 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-1"
