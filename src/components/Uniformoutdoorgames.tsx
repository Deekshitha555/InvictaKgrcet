"use client";
import { GiBasketballBasket, GiVolleyballBall, GiSprint, GiThrowingBall,GiCricketBat} from "react-icons/gi";
...
const Uniformoutdoorgames = () => {
    ...
    {
        title: "Women Throwball",
        description: "Showcase precision and teamwork in this dynamic game.",
        icon: <GiThrowingBall className="text-2xl text-yellow-400" />,
        img: "/images/outdoorgames/womenthrowball.png",
        imgAlt: "throwball",
        link: "/sports/outdoorgames/womenthrowball"
    },
    {
        title: "Dead Lift",
        ...
        imgAlt: "Table Tennis",
        link:"/sports/outdoorgames/deadlift"
    },
    ];
