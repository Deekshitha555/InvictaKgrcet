  ...
  return (
    ...
    >
      <div className="container flex flex-col space-y-10">
        ...
        <div className="flex flex-wrap justify-center md:justify-around items-center gap-6">
          {[
            ...
            <motion.div
              ...
              whileTap={{ scale: 1.1 }}
              className="w-48 h-38 sm:w-44 sm:h-44 md:w-28 md:h-28 flex items-center justify-center rounded-lg overflow-hidden"
            >
              <Image
                src={image.src}
                alt={image.alt}
        ...
        {/* Links Section */}
        <div className="text-center md:text-left md:w-1/3 mx-auto">
